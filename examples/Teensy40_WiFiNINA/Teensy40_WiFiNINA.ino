/****************************************************************************************************************************
   Teensy40_WiFiNINA.ino
   For Teensy 4.0 using WiFiNINA Modules/Shields, using much less code to support boards with smaller memory
...
void setup()
{
  ...
  Serial.println("\nStart Teensy40_WiFiNINA on " + String(BOARD_TYPE));
  ...
  WiFiManager_NINA->begin("Teensy-WiFiNINA-ABCDEF");
  //Or use default Hostname "Teensy-WiFiNINA-XXXXXX"
