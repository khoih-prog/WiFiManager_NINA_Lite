...
#define NO_CONFIG             "blank"
    ...
    bool dueFlashStorage_get(void)
    {
      ...
      WiFiNINA_Configuration* dataPointer = (WiFiNINA_Configuration* ) dueFlashStorage.readAddress(offset);
    ...
    void dueFlashStorage_put(void)
    {
      ...
      dueFlashStorage.write(offset, (byte *) &WiFiNINA_config, sizeof(WiFiNINA_config));
    ...
    bool getConfigData()
    {
           ...
           (calChecksum != WiFiNINA_config.checkSum) || !credDataValid )
      {
        ...
        DEBUG_WM2(F("InitData,sz="), totalDataSize);
